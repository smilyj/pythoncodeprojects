...
# actual sentence
print( f"Hi! My name is {name}. I woke up at {time1} to go to school, but schools starts at {time2}. \
After walking my {pronoun}, I decided to go get ready! I changed into my favourite outfit- a dressy pants \
